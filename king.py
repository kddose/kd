...
TOKEN = '7885434996:AAFyJltu6OoiLNenMv-gXs0-BwVQX4vBaM0'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002158050436
CHANNEL_ID = -1002158050436
error_channel_id = -1002158050436
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@00000*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@00000*", parse_mode='Markdown')
